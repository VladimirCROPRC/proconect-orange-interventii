...
export async function POST(request: Request) {
  try {
    ...
    if (section === "intervention-assessment" || section === "intervention-execution") {
      ...
      if ((section === "intervention-assessment" && category !== "damage" && category !== "site-measurement") || (section === "intervention-execution" && !/^[a-f0-9-]{36}:(?:photo|junction-open|junction-closed|junction-site)$/i.test(category))) {
